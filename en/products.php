...
$categoriesStmt = $pdo->query("
    ...
    JOIN category_translations ct 
      ON c.id = ct.category_id AND ct.language_code = 'en'
...
<section class="section">
    <div class="container">
        <h1 class="section-title">All Creations</h1>
        ...
        <form method="get" class="filters-grid" style="margin-top: 1rem;">
            ...
            <div>
                ...
                <input id="q" name="q" type="search" class="input" placeholder="Search for a product…" value="<?php echo e($search); ?>" data-product-search>
            </div>
            <div>
        ...
        <?php if ($products): ?>
            ...
            <?php if ($totalPages > 1): ?>
                <nav style="margin-top: 1.5rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
                    <?php for ($p = 1; $p <= $totalPages; $p++): ?>
                        ...
                        $urlParams = $_GET;
                        $urlParams['page'] = $p;
                        $url = '/en/products.php?' . http_build_query($urlParams);
                        ?>
            ...
            <?php endif; ?>
        <?php else: ?>
            <p style="margin-top: 1.5rem;">No products found for these filters.</p>
        <?php endif; ?>
    </div>
</section>
